...
import com.homesharing_backend.data.dto.DistrictDto;
import com.homesharing_backend.data.dto.PostDetailDto;
import com.homesharing_backend.data.dto.PostImageDto;
    ...
    */
    ...
    public ResponseEntity<JwtResponse> getPostDetailByPostID(Long postID) {
        ...
        if (postRepository.existsPostById(postID)) {
            ...
            PostDetail postDetail = postDetailRepository.findPostDetailById(postID)
            ...
            List<PostImage> postImages = (List<PostImage>) postImageRepository.getPostImageByPost_Id(postID)
                    .orElseThrow(() -> new NotFoundException("Không có post_id này trong post_image"));
            ...
            List<PostUtility> postUtilities = (List<PostUtility>) postUtilityRepository.getPostUtilitiesByPost_Id(postID)
                    .orElseThrow(() -> new NotFoundException("Không có post_id này trong post_utility"));
            ...
            PostDetailDto dto = PostDetailDto.builder()
                    ...
                    .hostName(postDetail.getPost().getHost().getUsername())
                    .imageUrlHost(postDetail.getPost().getHost().getUserDetail().getAvatarUrl())
